...
<head>
    ...
    <title>New employee - TaskHub</title>
    ...
    <div class="container">
        ...
        <form action="save.php" method="post" enctype="multipart/form-data" class="row">
            ...
            <div class="col-6">
                ...
                <select name="image" id="image" class="form-select mt-2 mb-3">
                    <?php while($employee = mysqli_fetch_assoc($employees_list)) { ?>
                        <option value="<?php echo $employee["id"]; ?>"> <?php echo $employee["name"] . "-" . $employee["image"]; ?></option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="col-6">
                ...
                <select name="name" id="name" class="form-select mt-2 mb-3">
                    <?php while($employee = mysqli_fetch_assoc($employees_list)) { ?>
                        <option value="<?php echo $employee["id"]; ?>"> <?php echo $employee["id"] . "-" . $employee["name"]; ?> </option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="col-6">
                ...
                <select name="phone" id="phone" class="form-select mt-2 mb-3">
                    <?php while($employee = mysqli_fetch_assoc($employees_list)) { ?>
                        <option value="<?php echo $employee["id"]; ?>"> <?php echo $employee["phone"]; ?> </option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="col-6">
                ...
                <select name="b_date" id="b_date" class="form-select mt-2 mb-3">
                    <?php while($employee = mysqli_fetch_assoc($employees_list)) { ?>
                        <option value="<?php echo $employee["id"]; ?>"> <?php echo $employee["birth_date"]; ?> </option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="col-6">
                ...
                <select name="department_id" id="department_id" class="form-select mt-2 mb-3">
                    <?php while($department = mysqli_fetch_assoc($departments_list)) { ?>
                        <option value="<?php echo $department["id"]; ?>"> <?php echo $department["id"] . "-" . $department["name"]; ?> </option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="col-6">
                ...
                <select name="city_id" id="city_id" class="form-select mt-2 mb-3">
                    <?php while($city = mysqli_fetch_assoc($cities_list)) { ?>
                        <option value="<?php echo $city["id"]; ?>"> <?php echo $city["id"] . "-" . $city["name"]; ?> </option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="col-6">
                ...
                <select name="task_id" id="task_id" class="form-select mt-2 mb-3">
                    <?php while($task = mysqli_fetch_assoc($tasks_list)) { ?>
                        <option value="<?php echo $task["id"]; ?>"> <?php echo $task["id"] . "-" . $task["name"]; ?> </option>
                    <?php } ?>
                </select>
            </div>
