...
<head>
    ...
    <title>Add New Priority - TaskHub</title>
...
<body>
    ...
    <div class="container">
        <h1 class="display-1 text-primary my-5">Add New Priority</h1>
        <form action="save.php" method="post" class="row">
          ...
          <div class="col-2">
            ...
            <input type="color" name="color" id="color" class="form-control form-control-color mt-2 mb-3">
          </div>
